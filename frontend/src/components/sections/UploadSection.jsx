        ...
        <div className="w-full max-w-3xl mx-auto">
            ...
            <div className="bg-white dark:bg-[#151515] border border-gray-200 dark:border-white/10 rounded-3xl overflow-hidden shadow-2xl relative transition-colors duration-300">
                ...
                <div className="p-6 md:p-8 min-h-[400px] flex flex-col">
                            ...
                            <div className="space-y-3">
                                <AnimatePresence>
                                    {files.map((file, idx) => (
                                        <motion.div
                                            ...
                                            className="group flex items-center gap-4 p-4 bg-gray-50 dark:bg-[#1a1a1a] border border-gray-200 dark:border-white/5 rounded-2xl hover:bg-white dark:hover:bg-[#202020] hover:shadow-md dark:hover:shadow-none transition-all"
                                        >
                                ...
                                <div className="relative mt-4">
                                    <input
                                        ...
                                        onClick={(e) => { e.target.value = null; }}
                                    />
                                    <button className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white px-4 py-2 rounded-xl hover:bg-gray-100 dark:hover:bg-white/5 transition-colors w-full justify-center border border-dashed border-gray-200 dark:border-white/10">
                                        <Plus size={16} />
                        ...
                        <div className="w-full mt-6 mb-2">
                            ...
                            <div className="w-full bg-gray-100 dark:bg-white/5 h-1 rounded-full overflow-hidden">
                                <motion.div
                                    ...
                                    className="bg-gradient-to-r from-orange-400 to-purple-500 h-full shadow-lg"
                                />
                            </div>
                        </div>
                    )}
                    ...
                    {/* Footer / Actions */}
                    <div className="mt-8 pt-6 border-t border-gray-100 dark:border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0">
                        ...
                        <div className="flex items-center gap-3 w-full md:w-auto justify-center md:justify-end">
                            {files.length > 0 && (
                                <button
                                    ...
                                    className="px-6 py-2.5 rounded-full text-sm font-medium text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/5 transition-colors"
                                >
                                    Clear all
                                </button>
                            )}
                            ...
                            <Button
                                ...
                                className={cn(
                                    ...
                                    files.length > 0
                                        ? "bg-indigo-600 dark:bg-white text-white dark:text-black hover:bg-indigo-700 dark:hover:bg-gray-200 shadow-xl shadow-indigo-500/20 dark:shadow-[0_0_20px_rgba(255,255,255,0.1)]"
                ...
                {loading && (
                    <div className="absolute inset-0 bg-white/80 dark:bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center">
                        <div className="text-center">
                            <div className="w-16 h-16 border-4 border-indigo-500/30 dark:border-white/10 border-t-indigo-600 dark:border-t-white rounded-full animate-spin mb-4 mx-auto"></div>
                            <p className="text-gray-900 dark:text-white font-medium animate-pulse">Analyzing sources...</p>
                        </div>
                    </div>
                )}
            </div>
